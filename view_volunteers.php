...
$msgt = $msgt . $sAPI->msgbox(0, "You can't participate in this program because it's past date or clashes with
ongoing.");
} else {
...
<head>
    ...
    <title>eVolunteer - Volunteer Program</title>
    ...
    <main class="container">
        ...
        <div class="my-3 p-3 bg-body rounded shadow-sm">
            ...
            <div class="border-bottom">
                <div class="text-muted">
                    ...
                    <span>Original Suggestions Post: <a href="view_suggestions.php?id=<?php echo $sid; ?>"
                            class="text-primary" style="text-decoration: none;">Click Here</a></span> <br>
                    <?php
                    if($pickedBy == $currentUserId) {
                        echo "<span>View Participant: <a href='get_volunteer_participant.php?id=$vp_id' style='text-decoration: none;'>Click here</a></span>";
                    }
                    ?>
                </div>
            </div>
            <div class="d-flex justify-content-between text-muted">
                <strong class="text-primary"></strong>
                <span>Picked by: <a class="text-primary" style="text-decoration: none;"
            ...
            <div class="d-flex justify-content-between text-muted">
                <span class="text-primary">
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]) . "?id=" . $vp_id; ?>"
                        method="POST">
        ...
        <div class="my-3 p-3 bg-body rounded shadow-sm">
            ...
            <form class="border-bottom my-3"
                action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]) . "?id=" . $vp_id; ?>" method="POST">
                <div class="form-floating">
