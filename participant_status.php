...
if(!(is_null($checkP)) && strlen(trim($checkP)) > 0) {
  $msgt = $sAPI->msgbox(0, "Your upcoming volunteer program is about to start!");
  $sAPI->updateParticipateNotified($currUser, $checkP);
}
...
<head>
    ...
    <title>eVolunteer - Participant Status</title>
        ...
        <div class="container-fluid">
            ...
            <div class="navbar-collapse offcanvas-collapse" id="navbarsExampleDefault">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="#">Participation Status</a>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="dropdown01" data-bs-toggle="dropdown"
