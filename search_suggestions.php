...
<head>
    ...
    <title>eVolunteer - Search Suggestions</title>
...
<body class="bg-light">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu mx-0 shadow" aria-labelledby="dropdown01">
                            ...
                            <li><a class="dropdown-item active" href="#">Search Suggestions</a></li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown">
    ...
    <main class="container">
        ...
        <div class="my-3 p-3 bg-body rounded shadow-sm">
            ...
            <form class="border-bottom my-3" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>"
                method="POST">
                <div class="form-floating">
                    <input type="text" class="form-control" id="searchID" name="search" placeholder="your search"
                ...
                <div class="d-flex justify-content-between">
                    ...
                    <span>
                        <input type="submit" name="searchSuggestions" value="search" class="btn btn-primary"
                            id="searchBtn">
                    </span>
                </div>
            </form>
