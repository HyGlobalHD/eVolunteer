...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  // display results
  $volunteerProgram = getVolunteerPost($offset, $limit);
} else {
  // default
  $currPage = 1;
  $volunteerProgram = getVolunteerPost($offset, $limit);
...
function getVolunteerPost($offsets, $limits)
{
  $volunteerProgram = "";
  $dbAPI = new db();
  $sAPI = new suggestions();
  $uAPI = new users();
  $detail = $sAPI->getVolunteerProgramLimitOrder($offsets, $limits, 'DESC');
  if(is_null($detail)) {
      $volunteerProgram = $volunteerProgram . "There is no volunteer program available for now.";
  } else {
...
<body class="bg-light">
            ...
            <div class="navbar-collapse offcanvas-collapse" id="navbarsExampleDefault">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu mx-0 shadow" aria-labelledby="dropdown01">
                            <li><a class="dropdown-item active" href="#">All Volunteer Program</a></li>
                            <li>
                                <hr class="dropdown-divider">
                            </li>
    ...
    <main class="container">
        ...
        <div class="my-3 p-3 bg-body rounded shadow-sm">
            ...
            <h6 class="border-bottom pb-2 mb-0">Volunteer Program</h6>
            <?php echo $volunteerProgram; ?>
