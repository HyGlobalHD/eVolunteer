    ...
    <main class="container">
        ...
        <div class="my-3 p-3 bg-body rounded shadow-sm">
            <div class="d-flex justify-content-between border-bottom">
                ...
                <a href="view_suggestions.php?id=<?php echo $vp_id; ?>"><button class="btn btn-success">Back</button></a>
            </div>
            <span>
                <?php echo $commentsectionMSG; ?>
            </span>
            <br>
            <form class="border-bottom my-3" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]) . "?vc_id=" . $vc_id . "&sid=" . $vp_id; ?>" method="POST">
